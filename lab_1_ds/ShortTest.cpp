...
void testAll() { //call each function to see if it is implemented
	...
	///////////////////////
	std::pair<TValue, TValue> ans_1(13, NULL_TVALUE);
	assert(m.add(420, 13) == true);
	assert(m.removeKey(420) == ans_1);
	assert(m.add(420, 13) == true);
	assert(m.add(420, 22) == true);
	std::pair<TValue, TValue> ans_2(13, 22);
	assert(m.removeKey(420) == ans_2);
	std::pair<TValue, TValue> ans_3(NULL_TVALUE, NULL_TVALUE);
	assert(m.removeKey(420) == ans_3);
